...
As instituições às quais são filiados os 
...
\paragraph{Países com maior produção científica}

\paragraph{Países mais citados}

\subsection{Métricas para Fontes de Informação}

\subsubsection{Fontes mais relevantes (globalmente)}

\subsubsection{Fontes mais relevantes localmente citadas}
...
\paragraph{Número bruto de citações}

\subsubsection{Dinâmica de publicação nas fontes}

\subsection{Mapas de Acoplamento}

\subsection{Informetrias: Estrutura do conhecimento}
