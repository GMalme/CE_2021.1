...
\begin{figure}
    ...
    \caption{Plotagem ``Três Campos'' (Sankey plot) do \dataset\   SBDAA@guioliunb: Autores mais relevantes.}
...
%    \caption{Plotagem ``Três Campos'' (Sankey plot) do dataset SBDAA@guioliunb: 20 Autores, Citações e Palavras-Chave mais proeminentes.}
%    \label{fig:SBDAA@guioliunb:ThreeFieldPlot}
%\end{figure}
