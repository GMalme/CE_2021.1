...
\textit{NLP}, uma junção de "\textit{deep learning}" e "\textit{fake}", se trata de técnicas de síntese de sons e imagens humanas baseadas em inteligência artificial. Com o avanço no desenvolvimento de algoritmos de \textit{deep learning}, é notório o crescimento na quantidade de tais conteúdos falsos publicados na internet.
