...
\newglossaryentry{Simulacao}{
    name = {Simulação},
    description = {
    Simulação é um processo de imitação da realidade, de uma dada operação ou do comportamento de um fenômeno observado a medida do tempo. Exemplo: uma simulação que observa como se dá o processo de distribuição de renda entre os agentes participantes, através um modelo simplificado, ao longo do tempo.
    %
    Fonte: \cite{banks_discrete-event_2001}.
    }
}