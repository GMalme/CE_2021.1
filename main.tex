...
\part{Introdução\label{part:intro}}
    ...
    \input{1-Introducao/tarefas/1.1-Glossario/espec-tarefa}
 
    \input{1-Introducao/tarefas/1.2-Impressoes-Ciencia/espec-tarefa}
...
\input{2-Analise-Exploratoria-Dados/tarefas/2.2-Pesquisa-Bibliografica/estudantes/main}
...
\input{3-Computacao-Experimental/tarefas/3.1-Componentes-Experimento/espec-tarefa}

\input{3-Computacao-Experimental/tarefas/3.1-Componentes-Experimento/estudantes/main}

\input{3-Computacao-Experimental/tarefas/3.2-PrimeiraSimulacaoEmPythonMesa/espec-tarefa}

\input{3-Computacao-Experimental/tarefas/3.2-PrimeiraSimulacaoEmPythonMesa/estudantes/main}

%\input{3-Computacao-Experimental/aulas/3.2-Computacao-Ciencia-Experimental-Simulacao/fundamentos}

%\input{aulas/3-Simulacao/fundamentos}
...
%\input{aulas/3-Simulacao/oodprotocol}
