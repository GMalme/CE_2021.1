...
Nota-se, com os resultados da tabela \ref{tab:MASSA2:Main}, que o \dataset\   abrange um período de 31 anos de publicações (1992 a 2022), evidenciando  a publicação de 1975 artigos em 136 revistas distintas. Esses artigos tem idade média de publicação de sete anos.
