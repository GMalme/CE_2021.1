...
\begin{description}
    ...
    \item{automation unit test}
\end{description}

\subsection{Explicação para os termos de busca usados\label{sec:titofrota:query}}

Os termos utilizados foram escolhidos com base nos principais temas que circundam as perguntas que quero responder. 

"test driven" se refere a uma técnica de desenvolvimento guiada por testes e otimizações recursivas
