...
\textit{Deep Learning} para \textit{Healthcare} refere-se na utilização de \textit{deep learning}, um ramo da aprendizagem de máquina baseado na aprendizagem de representações de dados, nos cuidados de saúde das pessoas.
...
{experiments/CaioMassucato/PesquisaBibliometrica/DeepLearning/query.txt}
...
Foram obtidos 4305 registros com a \textit{query} utilizada. Na exportação, foi utilizado o formato de arquivo de texto sem formatação, com os 29 campos disponíveis.
