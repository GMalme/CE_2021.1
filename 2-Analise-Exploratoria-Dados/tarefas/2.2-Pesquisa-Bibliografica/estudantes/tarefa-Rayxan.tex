...
Durante os últimos anos foram feitas várias pesquisas a cerca da Computação Quântica. 




fizeram uma pesquisa que visava aprofundar a questão da simulação multiagente em relação à computação experimental.
