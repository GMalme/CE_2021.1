...
\todo[color=yellow,author=jhcf]{ Introdução muito sucinta.}
...
As palavras chaves mais relacionadas ao tema, tirando o próprio nome do tema, são criptografia, prova interativa e autenticação.
\todo[author=jhcf,color=green]{O trabalho descreveu e explorou o tema de forma precisa, mas excessivamente sucinta. Não foram plenamente respondidas as perguntas de pesquisa. Poderia ter havido maior exploração dos dados produzidos.}
