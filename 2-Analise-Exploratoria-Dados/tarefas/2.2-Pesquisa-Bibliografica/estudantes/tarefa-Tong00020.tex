...
\subsection{O que já existe de pesquisa bibliométrica sobre esse tema?}
 ...
 \todo[author=jhcf,color=red]{A referência citada não foi encontrada.} 
...
\todo[author=jhcf,color=yellow]{Faltou explicar alguns termos da busca.}
...
\todo[author=jhcf,color=yellow]{Nem todos os registros são artigos.}
...
\todo[author=jhcf,color=green]{Ok. Agora o dataset contém apenas os registros relativos aos artigos.}

\subsection{Análise descritiva do \textit{dataset}} 
%MASSA@Tong00020}

\todo[author=jhcf,color=yellow]{Seria importante colocar um nome diferente de MASSA no dataset, algo como 
BDE@Tong (Big Data Economy).}
...
\todo[author=jhcf,color=red]{A figura Rede de co-ocorrência de palavras chaves não foi descrita. Um melhor título para a figura seria Rede de co-ocorrência de palavras chaves no dataset MASSA@Tong.}
