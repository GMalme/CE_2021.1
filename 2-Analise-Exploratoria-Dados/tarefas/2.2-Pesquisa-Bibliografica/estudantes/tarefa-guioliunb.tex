...
A figura \ref{fig:SBDAA@guioliunb:relevantdocuments} evidência as publicações mais referenciadas. Os 4 primeiros itens tem uma dominância considerável sobre os outros, contudo é interessante observar que podem ser dois trabalhos com referências acopladas, pois o número
...
table foot = \hline\hline
    ...
    \caption{25 artigos mais citados localmente no \dataset\ SBDAA@guioliunb.}
