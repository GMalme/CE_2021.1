...
Podemos ver na  figura \ref{map-autor} que os autores que fazem as pequisas são de países economicamente fortes, como China, .
...
A figura \ref{fig:map-tres} apresenta o mapa Conceitual do dataset. Nele podemos ver que as palavras chaves são divididas em três grandes grupos. 

O azul, onde se pesquisa sobre o impacto do crescimento da China. O vermelho, onde se fala do uso do 

\begin{figure}[ht]
    \centering
    \includegraphics[width=11cm]{experiments/Tong00020/PesquisaBibliometrica/Conceptual Structure/MASSA@Tong00020-Thematic Map.png}
