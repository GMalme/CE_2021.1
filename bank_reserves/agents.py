...
class Person(RandomWalker):
    def __init__(self, unique_id, pos, model, moore, bank, rich_threshold, trade_threshold):
        ...
        self.bank = bank
        # people with very different economic power are more unlike to trade with eachother
