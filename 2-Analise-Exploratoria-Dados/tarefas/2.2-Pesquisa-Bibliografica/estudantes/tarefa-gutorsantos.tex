...
Tendo em vista isso, a quantidade de informação contida no Big Data, há nele um cenário propício para a exploração desses dados com o intuito de tentar modelar algoritmos que forneçam algum tipo de previsão e, ou, análise dos dados resultando numa tomada de decisão muitas vezes sem a necessidade de intervenção humana. Com isso, a IA contribui positivamente para diversos campos do conhecimento, como por exemplo, na área médica, onde é possível gerar diagnósticos rápidos e precisos com base nesses algoritmos. Porém,
...
% ((artificial and intelligence) or (machine and learning) or (computer and vision)) and (racialism or racism or racial or ((ethnical or racial) and discrimination) or (race and prejudice) or (race and snobbery))
